    ...
    {%- block any_cell scoped -%}
        {%- if cell.cell_type == 'code'-%} 
            ...
            {%- block codecell scoped -%}
                {%- if resources.global_content_filter.include_input and (cell.source is not none) -%}
                    {%- block input_group -%}
        ...
        {%- elif cell.cell_type in ['markdown'] -%}
            {%- if resources.global_content_filter.include_markdown and (cell.source is not none) -%}
                {%- block markdowncell scoped-%} {%- endblock markdowncell -%}
            {%- endif -%}
        {%- elif cell.cell_type in ['raw'] -%}
            {%- if resources.global_content_filter.include_raw and (cell.source is not none) -%}
            ...
            {%- endif -%}
        {%- else -%}
            {%- if resources.global_content_filter.include_unknown and (cell.source is not none) -%}
